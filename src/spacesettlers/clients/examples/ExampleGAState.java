...
/**
 * Example state representation for a GA agent. Note this would need to be
 * significantly modified/augmented to work in the full case (it just looks at
 * one aspect of the information available to it). Note also that this
 * representation ignores which ship it is on the team and just looks for the
 * nearest asteroid.
 * 
 * @author amy
 *
...
public class ExampleGAState {
	...
	/**
	 * Generated by eclipse - make sure you update this when you update the state
	 * (just use eclipse to regenerate it)
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
