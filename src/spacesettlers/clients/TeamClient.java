...
abstract public class TeamClient {
	...
	/**
	 * Maximum number of ships (copy of what is stored in Team, since the individual
	 * clients can't access Team)
	 */
	int maxNumberShips;
	...
	/**
	 * Set the maximum number of ships (just a copy from Team, setting this inside
	 * your client will have NO effect on the simulator)
	 * 
	...
	/**
	 * Called when actions end but before time advances. Can be used to see if a
	 * ship died or other useful physics checks.
	 * 
	 * @param space
	 * @param actionableObjects the ships and bases for this team
	 * @param ships
	 */
	abstract public void getMovementEnd(Toroidal2DPhysics space, Set<AbstractActionableObject> actionableObjects);

	/**
	 * Called each time step to get the power up or weapon for each actionable
	 * object
	 * 
	 * @param space             physics
	 * @param actionableObjects the ships and bases for this team
	 ...
	 * @param clonedPurchaseCost how much each type of purchase currently costs for
	 *                           this team
	 * @return
	 */
	...
	/**
	 * If the client wants to take input from the keyboard, they need to override
	 * this to return a proper key listener. This shouldn't count as an exploit
	 * since it can't be used on the ladder. It can be useful for debugging so it is
	 * allowed for any client to override. The keys are only handled inside the
	 * client (the global GUI keys are handled by a separate listener)
	 * 
	 ...
	 * to return a proper mouse listener. This shouldn't count as an exploit since
	 * it can't be used on the ladder. It can be useful for debugging so it is
	 * allowed for any client to override. The mouse movements are only handled
	 * inside the client
	 * 
