...
public class RunSimulator {
	...
	/**
	 * Create a simulator with the command line arguments parsed. If they fail to
	 * parse, this will die before moving on.
	 * 
	 * @param args
	...
	/**
	 * Run the spacewar simulator. First parse and verify the command line arguments
	 * and then run the sim.
	 * 
	 * @param args
	 * @throws SimulatorException
	 */
