...
/**
 * Enum with the types of purchases that a team can make and a map to the right
 * powerup.
 *
 * @author amy
 */
public enum PurchaseTypes {
	BASE(), SHIP(), POWERUP_SHIELD(SpaceSettlersPowerupEnum.TOGGLE_SHIELD),
	...
	POWERUP_DOUBLE_WEAPON_CAPACITY(SpaceSettlersPowerupEnum.DOUBLE_WEAPON_CAPACITY), CORE(), DRONE(), NOTHING();
