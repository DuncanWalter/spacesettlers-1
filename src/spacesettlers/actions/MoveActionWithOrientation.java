...
/**
 * A move action specifies the setpoint to move to and the desired velocity and
 * orientation.
 * 
 * This action moves the ship to the desired location but turns to the requested
 * orientation
 * 
...
public class MoveActionWithOrientation extends MoveAction {
	 ...
	 * @param targetLocation  the target location of the ship - MAKE SURE THIS HAS
	 *                        AN ORIENTATION
	 * @param targetVelocity  the velocity the ship should be at when it reaches its
	 *                        target location
	 * @throws SpaceSettlersActionException
	 */
	public MoveActionWithOrientation(Toroidal2DPhysics space, Position currentLocation, Position targetLocation,
	...
	private double getOrientationError(Toroidal2DPhysics space, Position goalLoc, Position currentLoc) {
		// removed the vector computation as it was causing the bug where the ship would
		// always
		// orient to the goal along this vector and not to the goal orientation the user
		// specified
