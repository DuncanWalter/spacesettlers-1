...
/**
 * Keeps track of the costs of buying each item for a team. Costs go up as a
 * team makes purchases.
 * 
 * @author amy
 */
public class PurchaseCosts {
	...
	public void reset() {
		...
		/*
		 * The major expense of the drone should be the core. Compete gets lots of
		 * cores, but this serves little purpose there. The Core plus the drone costs
		 * about as much as a ship. I honestly think it might be too expensive, but we
		 * can play with the value.
		 */
	}
