...
/**
 * An AiCore is an object in the SpaceSettlers simulator that spawns when a ship
 * dies. The Ai Core takes damage by bouncing off objects and is restored when
 * it touches an energy beacon. It is collected when it collides with a base or
 * a ship.
 * 
...
public class AiCore extends AbstractObject {
	...
	/**
	 * Returns the current energy of the core. Can help avoid pursuing cores that
	 * are likely to die before the ship reaches them.
	 * 
	 * @return
	 */
