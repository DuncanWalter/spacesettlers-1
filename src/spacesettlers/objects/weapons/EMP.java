...
/**
 * Electro-magnetic pulse (EMP) that freezes any ship it hitsInflicted for a
 * specified amount of time. To use this, you have to buy the
 * POWERUP_EMP_LAUNCHER in purchases.
 * 
 * @author amy
 *
 */
public final class EMP extends AbstractWeapon implements SpaceSettlersPowerup {
	...
	/**
	 * Number of steps to freeze the ship it hitsInflicted (not a static since maybe
	 * a powerup count change it, if we add that)
	 */
	int freezeCount;
	...
	/**
	 * Can't fire with shields on so drop them. Then give it the cost of use
	 */
	@Override
