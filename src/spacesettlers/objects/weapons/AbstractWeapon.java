...
abstract public class AbstractWeapon extends AbstractObject implements SpaceSettlersPowerup {
	 ...
	 * @param costToUse
	 * @param teamName        Needed to ensure this weapon belongs to the ship that
	 *                        fired it
	 * @param firingShipId    Needed to ensure this weapon belongs to the ship that
	 *                        fired it
	 */
	...
	/**
	 * Return true if the weapon can be fired by the ship and team and false
	 * otherwise
	 * 
	 * @param teamName
	 * @param shipId
