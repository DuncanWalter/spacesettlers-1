...
public class LineGraphics extends SpacewarGraphics {
	...
	public LineGraphics(Position startPoint, Position endPoint, Vector2D startToFinish) {
		...
		// System.out.println("regular distance is " + regularDistance + " and shortest
		// is " + startToFinish.getMagnitude());
	 ...
	 * 
	 * TODO: Fix it so it does the wrapping externally like the other graphics (but
	 * it is harder here)
	 */
	public void draw(Graphics2D graphics) {
		...
		graphics.drawLine((int) startPoint.getX(), (int) startPoint.getY(), (int) endPoint.getX(),
				(int) endPoint.getY());
	}
