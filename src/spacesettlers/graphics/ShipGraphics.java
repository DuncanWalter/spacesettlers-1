...
public class ShipGraphics extends SpacewarGraphics {
    ...
    public static final Shape SHIP_SHAPE = new Polygon(
            new int[] { 54, 108, 100, 141, 85, 73, 106, 89, 80, 40, 54, -54, -40, -80, -89, -106, -73, -85, -141, -100,
                    -108, -54, 54 },
            new int[] { -89, 3, 18, 89, 89, 69, 69, 38, 53, 53, 75, 75, 53, 53, 38, 69, 69, 89, 89, 18, 3, -89, -89 },
            23);
    public static final Shape THRUST_SHAPE = new Polygon(new int[] { 44, -44, 0 }, new int[] { 65, 65, 200 }, 3);
    public static final Shape THRUST_SPUTTER_SHAPE = new Polygon(new int[] { 30, -30, 0 }, new int[] { 65, 65, 170 },
            3);
    ...
    public void draw(Graphics2D graphics) {
        ...
        // final Shape newThrustShape =
        // transform.createTransformedShape(THRUST_SPUTTER_SHAPE);
        ...
        // graphics.drawString(ship.getId().toString(), (int) drawLocation.getX() - 3,
        // (int) drawLocation.getY() + 3);
        ...
        // g.drawString(number, ship.getPosition().getX() + 12,
        // ship.getPosition().getY() + 1);
        //
        // if (ship.getName() != null) {
        // g.drawString(ship.getName(), ship.getPosition().getX() + 12,
        // ship.getPosition().getY() - 10);
        // }
        //
        // show the velocity
        graphics.setStroke(JSpaceSettlersComponent.THIN_STROKE);
        graphics.drawLine((int) drawLocation.getX(), (int) drawLocation.getY(),
        ...
        // g.drawString(number, ship.getPosition().getX() - 24,
        // ship.getPosition().getY() - 10);
        //
        ...
        // if the ship is frozen from an EMP, show a ring around it (in the ship's own
        // color)
        ...
        if (ship.isCarryingFlag()) {
            AffineTransform transformFlag = AffineTransform.getTranslateInstance(drawLocation.getX(),
                    drawLocation.getY());
    ...
    /**
     * Only draw a ship if it is alive and drawable (ships should always be
     * drawable)
     */
