...
public class DroneGraphics extends SpacewarGraphics {
    ...
    public static final Shape DRONE_SHAPE = new Polygon(
            new int[] { 81, 81, 41, 41, 51, 51, -51, -51, -41, -41, -81, -81, 81 },
            new int[] { -93, 93, 93, 71, 71, -22, -22, 71, 71, 93, 93, -93, -93 }, 13);
    ...
    public void draw(Graphics2D graphics) {
        ...
        // if the drone is frozen from an EMP, show a ring around it (in the drone's own
        // color)
    ...
    /**
     * Only draw a drone if it is alive and drawable (drones should always be
     * drawable)
     */
