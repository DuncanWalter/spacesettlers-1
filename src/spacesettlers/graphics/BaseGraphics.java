...
public class BaseGraphics extends SpacewarGraphics {
	...
	public void draw(Graphics2D graphics) {
		...
		graphics.fillOval((int) (drawLocation.getX() - radius), (int) (drawLocation.getY() - radius), (int) diameter,
				(int) diameter);

		// draw an outline around the base (in case its healing energy goes to 0)
		final Ellipse2D.Double shape = new Ellipse2D.Double(drawLocation.getX() - radius, drawLocation.getY() - radius,
				diameter, diameter);
		...
		// graphics.setPaint(JSpaceSettlersComponent.TEXT_COLOR);
		// graphics.drawString(number, (int) drawLocation.getX() + 12, (int)
		// drawLocation.getY() - 12);
