...
/**
 * Abstract class for all graphics in the spacesettlers simulator. The idea is
 * based on shadow from the spacewar1 simulator
 * 
 * @author amy
 */
abstract public class SpacewarGraphics {
	/**
	 * Temporary variable used to deal with toroidial worlds. The main GUI can set
	 * this to handle the wrapping
	 */
	...
	/**
	 * Initialize the size information for a graphic. Required of all graphics.
	 * 
	 * @param height
	 * @param width
	 */
	...
	/**
	 * Set the drawing location (should only be called by the main GUI)
	 * 
