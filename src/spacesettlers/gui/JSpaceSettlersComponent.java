...
/**
 * Main Space Settlers window component. Note some of this code is from the
 * original spacewar gui.
 * 
 * @author amy
 */
...
public class JSpaceSettlersComponent extends JComponent {
    ...
    public JSpaceSettlersComponent(int height, int width) {
        ...
        // System.out.println("Setting preferred width " + width + " and height " +
        // height);
    ...
    /**
     * Handles drawing things in a tororodially wrapped world. Code comes from the
     * spacewar 1 simulator.
     * 
